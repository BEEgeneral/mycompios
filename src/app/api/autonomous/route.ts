...
export async function POST(req: Request) {
  ...
  try {
    ...
    const { action, companyId, instruction, task, agentId, content, taskType } = body as { action?: string; companyId?: string; instruction?: string; task?: any; agentId?: string; content?: string; taskType?: string }
